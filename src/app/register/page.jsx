            ...
            >
                <div className="w-full max-w-md lg:max-w-lg rounded-4xl border border-white/10 bg-white/5 p-6 lg:p-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full rounded-xl bg-gradient-to-r from-red-600 to-red-500 py-3 font-medium transition-all duration-300 hover:shadow-[0_0_25px_rgba(220,38,38,0.35)]"
                        >
                            Register
                        </button>
                        ...
                        >
                            <span className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-red-500/10 to-transparent transition-transform duration-700 group-hover:translate-x-full"></span>
